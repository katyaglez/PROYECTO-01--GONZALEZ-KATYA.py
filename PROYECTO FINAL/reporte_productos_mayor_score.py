...
# "generar_lista_ordenada_mayor_score" ordena de mayor a menor los productos tomando como parámetro para ordenar el average_score
def generar_lista_ordenada_mayor_score():
    ...
    return lista_productos_score_ordenada[::-1]
    

# "generar_reporte_menos_score" genera el reporte de los 5 productos peor evaluados (mayor score)
...
def generar_reporte_mayor_score():
    lista_productos_score_ordenada = generar_lista_ordenada_mayor_score()
    print("****************************************************************************************************************************************")
    print("****************************************************************************************************************************************")
    print("Listado de productos con MEJORES reseñas")
    i = 1
